 ...
 * @author deive
 */
public class InstrutorLLL extends javax.swing.JFrame {
...
//        lista.add(cliente);//
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        if (index != -1) {
            ...
            try {
                ...
                Logger.getLogger(InstrutorLLL.class.getName()).log(Level.SEVERE, null, ex);
            }
        } else {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(InstrutorLLL.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
